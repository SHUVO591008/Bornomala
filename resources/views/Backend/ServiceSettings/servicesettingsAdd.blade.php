        ...
        <div class="row">
          ...
          <div id="breadcrumbs-wrapper" data-image="{{asset("Backend/app-assets/images/gallery/breadcrumb-bg.jpg")}}">
              ...
              <div class="col s12">
                ...
                <!-- service settings Add -->
                <div class="container">
                    <div class="row">
                        <form id="servicesettings" class="col s12" action="@if(@isset($data)){{route('service.update',Crypt::encrypt($data->id))}} @else{{route('service.store')}} @endif" method="POST"  >
                             @csrf
                             <div class="card">
                                    <div class="card-content">
                                        <div  class="card-header col m12 s12">
                                            <h4 style="float: left;" class="General card-title">Service Settings</h4>
                                            ...
                                            @if(@isset($data))
                                                 <a class="btn right mr-3" href="{{route('service.add')}}">Add</a>
                                             @endif
                                    ...
                                    <!-- warning msg show End-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col m12 s12">
                                                ...
                                                <input value="@if(@isset($data)){{$data->slogan}}@else{{old('text')}}@endif" id="text" name="text" type="text" class="validate" data-error=".errortext" required="">
                  ...
                  <div class="row">
                    <div class="col s12 m12 l12">
                      <div id="responsive-table" class="card card card-default scrollspy">
                        <div class="card-content">
                           <div  class="card-header col m12 s12">
                                <h4 style="text-align: center;background: #d2ef5e;color: black;padding: 10px;    font-weight: 700;" class="General card-title ">Service Settings Show</h4>
                                <hr>
                            </div>
                          <div class="row">
                            <div class="col s12">
                                    ...
                                    @else
                                        @foreach($service as $key)
                                            <tr>
                                              <td>{{ $sl++ }}</td>
                                              <td>{{$key->title}}</td>
                                              <td style="width:20%">{{$key->slogan}}</td>
                                              ...
                                              <td>
                                                ...
                                                <div class="switch">
                                                    <label>
                                                      <span>Inactive</span>
                                                      <input data-column="{{route('service.status')}}" class="status" data-id="{{$prodID}}" id="status" {{($key->status==1)?'checked':''}} type="checkbox">
                                              ...
                                              <td>
                                                  <a class="btn-floating waves-effect waves-light amber darken-4 mr-5" href="{{route('service.edit',$prodID)}}" title="Edit"><i style="font-size: 14px;" class="fa-solid fa-pen-to-square"></i></a>
                                                  

                                                  <a class="delete-confirm btn-floating waves-effect waves-light green darken-1" href="{{ route('service.delete',$prodID) }}" title="Delete"><i style="font-size: 14px;" class="fa-solid fa-trash-can"></i></a>
                                              </td>
                                           </tr>
                                        @endforeach
                                    @endif
