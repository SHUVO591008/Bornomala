           ...
           <div class="col s12 m4">
              <div class="card animate fadeLeft">
                 <div class="card-content  center">
                    ...
                    <img src="../../../Backend/app-assets/images/cards/watch.png" alt="" class="responsive-img">
           ...
           <div class="col s12 m4">
              <div class="card animate fadeUp">
                 <div class="card-content center">
                    ...
                    <img src="../../../Backend/app-assets/images/cards/headphones-2.png" alt="" class="responsive-img">
                 </div>
           ...
           <div class="col s12 m4">
              <div class="card animate fadeRight">
                 <div class="card-content center">
                    ...
                    <img src="../../../Backend/app-assets/images/cards/iphonec.png" alt="" class="responsive-img">
           ...
           <div class="row">
              <div class="col s12 m3">
                 <div class="card gradient-shadow gradient-45deg-light-blue-cyan border-radius-3 animate fadeUp">
                    <div class="card-content center">
                       <img src="../../../Backend/app-assets/images/icon/apple-watch.png" class="width-40 border-round z-depth-5 responsive-img" alt="image">
              ...
              <div class="col s12 m3">
                 <div class="card gradient-shadow gradient-45deg-red-pink border-radius-3 animate fadeUp">
                    <div class="card-content center">
                       <img src="../../../Backend/app-assets/images/icon/printer.png" class="width-40 border-round z-depth-5 responsive-img" alt="images">
              ...
              <div class="col s12 m3">
                 <div class="card gradient-shadow gradient-45deg-amber-amber border-radius-3 animate fadeUp">
                    <div class="card-content center">
                       <img src="../../../Backend/app-assets/images/icon/laptop.png" class="width-40 border-round z-depth-5 responsive-img" alt="image">
              ...
              <div class="col s12 m3">
                 <div class="card gradient-shadow gradient-45deg-green-teal border-radius-3 animate fadeUp">
                    <div class="card-content center">
                       <img src="../../../Backend/app-assets/images/icon/bowling.png" class="width-40 border-round z-depth-5 responsive-img" alt="image">
