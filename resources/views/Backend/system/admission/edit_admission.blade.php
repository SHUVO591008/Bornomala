        ...
        <div class="row">
          ...
          <div id="breadcrumbs-wrapper" data-image="{{asset("Backend/app-assets/images/gallery/breadcrumb-bg.jpg")}}">
                ...
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col s12 m6 l6">
                      <h5 class="breadcrumbs-title mt-0 mb-0"><span>Edit Admission Form</span></h5>
                    </div>
                    ...
                    <div class="col s12 m6 l6 right-align-md">
                      <ol class="breadcrumbs mb-0">
                        ...
                        <li class="breadcrumb-item active">Edit Admission
                        </li>
                      </ol>
                    </div>
              ...
              <div class="col s12">
                ...
                <div class="container">
                    <div class="row">
                        @php $UserID= Crypt::encrypt($allData->id); @endphp
                        <form id="UpdateformValidate" class="col s12" action="{{route('admission.update',$UserID)}}" method="POST"  enctype="multipart/form-data">
                             @csrf
                             <div class="card">
                                    ...
                                    <!-- warning msg show End-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div style="overflow: hidden;">
                                                ...
                                                <div class="input-field col l3 m3 s12">
                                                    ...
                                                    <input value="{{$allData->first_name}}" type="text" id="firstName" name="firstName" class="validate" required="" data-error=".errorFname">
                                                    <small class="errorFname"></small>
                                                </div>

                                                <div class="input-field col l3 m3 s12">
                                                    <label for="lastName">Last Name: <span class="red-text">*</span></label>
                                                    <input value="{{$allData->last_name}}" type="text" id="lastName" class="validate" name="lastName" required="" data-error=".errorLname">
                                                ...
                                                <div class="input-field col l3 m3 s12">
                                                    ...
                                                    <input  value="{{date('d/m/Y', strtotime($allData->admission_date))}}" id="admission_date" name="admission_date" type="text" class="admission_date datepicker" placeholder="dd/mm/yy" required="" data-error=".erroradmission_date">
                                                    <small class="erroradmission_date"></small>
                                                </div>

                                                <div class="input-field col l3 m3 s12">
                                                    <label for="phone">Mobile: <span class="red-text">*</span></label>
                                                    <input value="{{$allData->mobile}}" name="phone" id="phone" type="number" class="validate" required="" data-error=".errorMobile">
                                            ...
                                            <div style="overflow: hidden;">
                                                ...
                                                <div class="input-field col l3 m3 s12">
                                                    ...
                                                    <input value="{{$allData->email}}" type="email" class="validate" name="email" id="email" data-error=".errorEmail" readonly>
                                                ...
                                                <div class="input-field col l3 m3 s12">
                                                    ...
                                                    <option {{ ($allData->gender=='male')?"selected":""}}  value="male">Male</option>
                                                    <option {{ ($allData->gender=='female')?"selected":""}} value="female">Female</option>
                                                    <option {{ ($allData->gender=='other')?"selected":""}} value="other">Other</option>
                                                    </select>
                                                ...
                                                <div class="input-field col l3 m3 s12">
                                                    ...
                                                    <option {{ ($allData->religion=='hinduism')?"selected":""}} value="hinduism">Hinduism</option>
                                                    <option {{ ($allData->religion=='islam')?"selected":""}} value="islam">Islam</option>
                                                    <option {{ ($allData->religion=='buddhists')?"selected":""}} value="buddhists">Buddhists</option>
                                                    <option {{ ($allData->religion=='christianity')?"selected":""}} value="christianity">Christianity</option>
                                                    </select>
                                                ...
                                                <div class="input-field col l3 m3 s12">
                                                    ...
                                                    <option {{ ($allData->blood_group=='A+')?"selected":""}}  value="A+">A+</option>
                                                    <option {{ ($allData->blood_group=='A-')?"selected":""}} value="A-">A-</option>
                                                    <option {{ ($allData->blood_group=='B+')?"selected":""}} value="B+">B+</option>
                                                    <option {{ ($allData->blood_group=='B-')?"selected":""}} value="B-">B-</option>
                                                    <option {{ ($allData->blood_group=='O+')?"selected":""}} value="O+">O+</option>
                                                    <option {{ ($allData->blood_group=='O-')?"selected":""}} value="O-">O-</option>
                                                    <option {{ ($allData->blood_group=='AB+')?"selected":""}} value="AB+">AB+</option>
                                                    <option {{ ($allData->blood_group=='AB-')?"selected":""}} value="AB-">AB-</option>
                                                    </select>
                                        ...
                                        <div >
                                            <div class="input-field col l3 m3 s12">
                                                ...
                                                <input value="{{date('d/m/Y', strtotime($allData->dob))}}" id="dob" name="dob" type="text" class="birthdate-picker " placeholder="dd/mm/yy" required="" data-error=".errorDatepicker">
                                            ...
                                            <div class="input-field col l3 m3 s12">
                                                <div style="text-align: center;" class="">
                                                    <img style="max-width: 44%;width:44%;height: 160px" id="image" src="{{asset($allData->student_image)}}" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                           <div style="overflow: hidden;">
                                            ...
                                            <div class="input-field col l4 m4 s12">
                                                ...
                                                @endphp
                                                    @foreach($class as $key)
                                                        ...
                                                        <option {{ ($allData->class_id==$key->id)?"selected":""}} value="{{ Crypt::encrypt($key->id) }}">{{ $key->class }}</option>
                                                    @endforeach
                                            ...
                                            <div class="input-field col m4 l4 s12">
                                                <select class="select2 browser-default validate" name="section_id" id="section_id" data-error=".section_id" required="">
                                                    ...
                                                    $sections=DB::table('sections')
                                                        ->where('class_id',$allData->class_id)
                                                        ->get();
                                                    @endphp

                                                    @foreach($sections as $key)                                      
                                                        <option {{ ($allData->section_id==$key->id)?"selected":""}} value="{{$key->id}}">{{ $key->section }}</option>
                                                    @endforeach
                                            ...
                                            <div class="input-field col l4 m4 s12">
                                                ...
                                                @endphp
                                                @foreach($year as $key)
                                                        <option {{ ($allData->year_id==$key->id)?"selected":""}} value="{{ Crypt::encrypt($key->id) }}">{{ $key->year }}</option>
                                                @endforeach
                                         ...
                                         <div style="overflow: hidden;">
                                            ...
                                            <div class="input-field col l4 m4 s12">
                                                ...
                                                <option {{ ($allData->scholarship=='full_fee')?"selected":""}} value="full_fee">Full Fee</option>
                                                <option {{ ($allData->scholarship=='half_fee')?"selected":""}} value="half_fee">Half Fee</option>
                                             ...
                                             <div class="input-field col l4 m4 s12">
                                                ...
                                                <input value="{{$allData->admission_fee}}" id="admission_fee" name="admission_fee" type="number" class="validate" required="" data-error=".erroradmission_fee" readonly="">
                                                <small class="erroradmission_fee"></small>
                                            </div>

                                             <div class="input-field col l4 m4 s12">
                                                <label for="discount">Discount (%)</label>
                                                <input value="{{$allData->discount}}" id="discount" name="discount" type="number" class="validate" required="" data-error=".errordiscount" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col l5 m5 s12">
                                                ...
                                                <input value="{{$allData->father_name}}" id="father_name" name="father_name" type="text" class="validate" required="" data-error=".errorfather_name">
                                            ...
                                            <div class="input-field col l7 m7 s12">
                                                ...
                                                <input value="{{$allData->father_occupation}}" id="father_occupation" name="father_occupation" type="text" class="validate" required="" data-error=".errorfather_occupation">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col l5 m5 s12">
                                                ...
                                                <input value="{{$allData->mother_name}}" id="mother_name" name="mother_name" type="text"  class="validate" required="" data-error=".errormother_name">
                                                <small class="errormother_name"></small>
                                            </div>

                                            <div class="input-field col l7 m7 s12">
                                                <label for="mother_occupation">Mother Occupation<span class="red-text">*</span></label>
                                                <input value="{{$allData->mother_occupation}}" id="mother_occupation" name="mother_occupation" type="text" class="validate" required="" data-error=".errormother_occupation">
                                        ...
                                        <div class="row">
                                            ...
                                            <h5 class="column-title">
                                             ...
                                             <div class="input-field col l3 m3 s12">
                                                ...
                                                <input value="{{$allData->gurdian_mobile}}" name="gurdian_mobile" id="gurdian_mobile" type="number" class="validate" required="" data-error=".errorgurdian_mobile">
                                                <small class="errorgurdian_mobile"></small>
                                            </div>

                                            <div class="input-field col l3 m3 s12">
                                                <label for="nid_number">Gurdian NID: <span class="red-text">*</span></label>
                                                <input value="{{$allData->nid_number}}" name="nid_number" id="nid_number" type="number" class="validate" required="" data-error=".errornid_number">
                                            ...
                                            <div class="input-field col l3 m3 s12">
                                                <div style="text-align: center;" class="">
                                                    <img style="max-width: 44%;width:44%;height: 160px" id="gurdian" src="{{asset($allData->gurdian_image)}}" />
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col l4 m4 s12">
                                                ...
                                                <input value="{{$allData->present_address}}" id="address1" name="address1" type="text" class="validate" required="" data-error=".errorAddress1">
                                            <small class="errorAddress1"></small>
                                            </div>

                                            <div class="input-field col l4 m4 s12">
                                                <label for="address2">Permanent  address <span class="red-text">*</span></label>
                                                <input value="{{$allData->permanent_address}}" id="address2" name="address2" type="text" class="validate" required="" data-error=".errorAddress2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col l8 m8 s12">
                                                ...
                                                <input value="{{$allData->school_collage}}" id="school_collage" name="school_collage" type="text" class="validate" required="" data-error=".errorschool_collage">
                                                <small class="errorschool_collage"></small>
                                            </div>

                                            <div class="input-field col l4 m4 s12">
                                                <label for="school_collage_class">Class Name<span class="red-text">*</span></label>
                                                <input value="{{$allData->school_collage_class}}" id="school_collage_class" name="school_collage_class" type="text" class="validate" required="" data-error=".errorschool_collage_class">
                                                    ...
                                                    <div id="delete_add_more_item" class="delete_add_more_item">
                                                            <div class="row">
                                                                <div class="input-field col m3 s6">
                                                                        ...
                                                                        <select class="select2 browser-default validate" name="socialicon[]" id="socialicon{{ $sl++ }}" data-error=".socialicon30" required="">
                                                                            <option value="" selected> <i class="fab fa-twitter"></i> Select Social Link</option>
                                                                            <option {{ ($key->socialicon=='facebook')?"selected":""}}  value="facebook">Facebook</option>
                                                                            <option {{ ($key->socialicon=='twitter')?"selected":""}}  value="twitter">Twitter</option>
                                                                            <option {{ ($key->socialicon=='linkedIn')?"selected":""}}  value="linkedIn">LinkedIn</option>
                                                                            <option {{ ($key->socialicon=='instagram')?"selected":""}}  value="instagram">Instagram</option>      
                                                                        </select>
                                                                ...
                                                                <div class="input-field col m7 s12">
                                                                    <label>Url</label>
                                                                    <input value="{{ ($key->socialUrl)}}"  name="socialUrl[]" class="validate" type="url">
                                                                </div>
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="input-field col l6 m6 s12">
                                                ...
                                                <input value="{{$allData->user_name}}" id="username" name="username" type="text" class="validate" data-error=".errorusername" required="" readonly>
                                                <small class="errorusername"></small>
                                            </div>

                                            

                                            <div class="input-field col l6 m6 s12 last">
                                                <select class="validate" name="status" id="status" data-error=".errorTxt35" required="">
                                                  <option  value="" disabled selected>Select Status</option>
                                                  <option {{ ($allData->status=='active')?"selected":""}}  value="active">Active</option>
                                                  <option {{ ($allData->status=='inactive')?"selected":""}} value="inactive">Inactive</option>
                                                </select>
                                            ...
                                            <div class="input-field col l12 m12 s12">
                                                ...
                                                <input value="{{$allData->about}}" id="about" name="about" type="text" data-error=".errorabout">
