    ...
    <div class="row">
      <div class="col s12 m7">
        <div class="display-flex media">
          <a href="#" class="avatar">
            <img src="{{asset($data->image)}}" alt="users view avatar" class="z-depth-4 circle" height="64" width="64">
          </a>
          <div class="media-body">
            ...
            <span>ID:</span>
            <span class="">{{$data->unique_id}}</span>
          </div>
        </div>
      </div>
          ...
          <table class="striped">
            <tbody>
              ...
              <tr>
                ...
                <td class="">30/04/2019</td>
              </tr>
              <tr>
                <td>Verified:</td>
                <td class="">
              
                  @if($data->valid_code==null)
                    Yes
                  @else
                    No
                @endif
              ...
              <tr>
                <td>Status:</td>
                <td><span class=" chip green lighten-5 green-text">
                  {{$data->status}}
                </span></td>
              </tr>
            </tbody>
    ...
    <div class="card-content">
      ...
      <div class="row">
        <div class="col s12">
          ...
          <table class="striped">
            <tbody>
              @foreach($data->usersocials as $key)
              <tr>
                <td>{{$key->socialicon}}:</td>
          ...
          <h6 class="mb-2 mt-2 "><i class="fa-solid fa-book mr-1"></i>Education</h6>
